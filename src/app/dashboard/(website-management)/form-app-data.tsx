...
import { FormAboutHighlights } from "./form-about-highlights";
...
export function FormAppData({ shows, categories }: FormAppDataProps) {
    ...
    const contentTabs = [
      {
        ...
        label: "Privasi",
        icon: Shield,
        show: shows.includes("privacy"),
      },
      {
        value: "terms",
        label: "Ketentuan",
        icon: FileText,
        show: shows.includes("terms"),
      },
      {
        value: "faq",
        label: "FAQ",
        icon: HelpCircle,
        show: shows.includes("faq"),
      },
    ];
  ...
  const websiteTabs = [
    ...
    },
    {
      ...
      label: "Branding",
      icon: Sparkles,
      show: shows.includes("branding"),
    },
    {
      value: "partners",
      label: "Partners",
      icon: Users2,
      show: shows.includes("partners"),
    },
    {
      value: "socials",
      label: "Social Media",
      icon: Share2,
      show: shows.includes("socials"),
    },
    {
      value: "kategori-zhub",
      label: "Kategori Zhub",
      icon: Grid3x3,
      show: shows.includes("kategori-zhub"),
    },
  ];
  ...
  return (
    <Tabs defaultValue={visibleTabs[0]?.value} className="w-full">
      ...
      <div className="hidden lg:block">
        <TabsList
          className={`grid w-full h-12 gap-1 bg-muted/50 p-1 rounded-xl`}
          style={{
