...
export const FormFaq = () => {
  ...
  return (
    <Form {...form.faq}>
      <form onSubmit={onSubmit.faq}>
        <Card>
          <CardContent className="space-y-4">
            <FormField
              control={form.faq.control}
              name="faq"
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <RichTextEditor
                      ...
                      placeholder="Tulis isi halaman faq di sini…"
            ...
            <div className="flex items-center justify-end">
              <Button type="submit" disabled={form.faq.formState.isSubmitting}>
                {form.faq.formState.isSubmitting ? (
